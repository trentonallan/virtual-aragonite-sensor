...
# Avoid redownloading ETOPO1 data if it already exists
if not bathy_file.exists():
    ...
    print("Successfully downloaded ETOPO1 bathymetry")
...
print("\nSuccessfully loaded bathymetry grid")
