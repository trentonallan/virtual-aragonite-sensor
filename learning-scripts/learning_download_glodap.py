...
# Ignore pandas warnings caused by GLODAP data with mixed types
...
Path("../learning-data/raw").mkdir(parents=True, exist_ok=True)
Path("../learning-data/processed").mkdir(parents=True, exist_ok=True)

# Define file path to read data from
output_path = "../learning-data/raw/glodap_v2_2023.csv"
...
print("Successfully filtered for {len(df_surface):,} surface samples")
